...
def process_data(data):
    ...
    summary = ["The {} generated the most revenue: ${}".format(format_car(max_revenue["car"]), max_revenue["revenue"]),"The {} had the most sales: {}".format(sales["car"]["car_model"], sales["to$
...
def main(argv):
  ...
  data = load_data("/home/student-02-3fad3b0a63b9/car_sales.json")
  ...
  msg = email_generate("automation@example.com", "student-02-3fad3b0a63b9@examp$
  email_send(msg)
